    ...
    <div id="sensei-chat-box" className="bg-slate-900 border border-slate-800 rounded-2xl p-5 flex flex-col h-[calc(100vh-140px)] shadow-lg shadow-black/50">
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-3 mb-4 select-none shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-accent-purple/15 text-accent-purple border border-accent-purple/30 rounded-xl flex items-center justify-center shadow-lg shadow-accent-purple/10">
            <BrainCircuit size={18} className="animate-pulse" />
          </div>
          <div>
            <div className="flex items-center gap-1.5">
              <h3 className="font-display font-bold text-sm text-white">SELECT SENSEI</h3>
              <span className="bg-accent-purple/20 text-accent-purple border border-accent-purple/20 text-[8px] font-mono rounded px-1.5 py-0.5 tracking-wider font-extrabold uppercase">AI · PREMIUM</span>
            </div>
            <p className="text-[10px] text-slate-500 font-mono">MODEL: GEMINI 3.5 FLASH • REAL-TIME CALCULATED CONTEXT</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto space-y-4 pr-1 scrollbar-thin">
              ...
              <div className="space-y-1">
                <div className={`rounded-2xl px-4 py-3 text-xs leading-relaxed ${
                  isModel 
                    ...
                    : "bg-accent-purple/90 text-white rounded-tr-none font-medium"
                }`}>
        ...
        {loading && (
          <div className="flex items-start gap-3.5 max-w-[80%] self-start animate-pulse">
            <div className="w-8 h-8 rounded-lg bg-accent-purple/15 text-accent-purple border border-accent-purple/20 flex items-center justify-center shrink-0">
              🏯
            </div>
      ...
      >
        ...
        <button
          ...
          className="w-8 h-8 rounded-lg bg-accent-purple hover:bg-accent-purple-hover text-white flex items-center justify-center transition-all disabled:opacity-30 disabled:hover:bg-accent-purple cursor-pointer shrink-0"
        >
          <Send size={13} />
        </button>
      </form>
